...
//   const handleExport = () => {
//     ExportExcel(filteredAppointments, "open_appointments_data.xlsx"); // Updated to use filteredAppointments
//   };
...
//   // Reset filters (only text filters)
//   const handleReset = () => {
...
//               </thead>
//               <tbody>
//                 {filteredAppointments.map((inquiry, index) => (
//                   <tr
//                     key={inquiry._id}
//                     className={`border-t ${
...
//                   >
//                     <td className="px-3 py-2 border border-[#FF6600] text-lg truncate  text-[#3f3e3d] font-bold">{index + 1}</td>
