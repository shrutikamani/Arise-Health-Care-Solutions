...
// import DateRangeFilter from "./DateRangeFilter"; // Fix #4: Consistent import path
// import ExportExcel from "../../common/ExportExcel"; // Fix #2: Uncommented import (assumed path)

// // Fix #3: Define initialFilters explicitly
...
//       // Fix #1: Added date range filtering logic
...
//   // Fix #3: Use initialFilters in handleReset
//   const handleReset = () => {
...
//   // Fix #2: Implemented handleExport with ExportExcel
//   const handleExport = () => {
...
//       <AdminSidebar /> {/* Fix #5: Assumes handleClickOutside is implemented */}
...
//           <p className="text-center text-yellow-600 text-lg">No Pending Inquiries Found</p>
//         ) : (
