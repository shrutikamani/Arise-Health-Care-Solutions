...
//           <h3 className="text-dark fw-semibold p-2">All Appointments</h3>
...
//                       <button className="btn btn-primary btn-md" onClick={() => submitRemark(appointment._id)}>
//                         Save
//                       </button>
//                       <button className="btn btn-danger btn-md" onClick={() => deleteAppointment(appointment._id)}>
//                         <FaTrash />
//                       </button>
//                     </td>
//                   </tr>
