  ...
  // import {
  //   FaMapMarkerAlt, FaPhoneAlt, FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn
  // } from "react-icons/fa";
  ...
  //       {/* Contact Section */}
  //       <div className="container-fluid  py-5"style={{ backgroundColor: "rgba(240, 242, 245, 0.9)" }}>
  //         <BubbleBackground/>
  ...
  //           <div className="row justify-content-center text-blue-900">
  //             {/* Contact Info */}
  //             <div
  ...
  //               data-aos-delay="400"
  //             >
  //               <div className="text-blue-900 d-flex align-items-center p-4">
  //                 <h3 className="mb-0 flex flex-column">
  //                   <Link to="tel:+919998967036" className="flex align-items-center mb-6 text-blue-900">
  //                     <motion.div
  ...
  //                     +91 99989 67036
  //                   </Link>
  //                   <Link to="tel:+918530100483" className="d-flex align-items-center text-blue-900">
  //                     <motion.div
  //                       animate={{ scale: [1, 1.2, 1] }}
  //                       transition={{ repeat: Infinity, duration: 1.5 }}
  //                     >
  ...
  //                 </motion.div>
  //                 <h4>
  //                   <Link to="https://www.google.com/maps/search/334-Lotus+Enora+Opp+Rutuvilla+Bunglows,+New+Alkapuri,+Vadodara-391101/"
  //                     className="text-blue-900">
  //                     334-Lotus Enora, Opp Rutuvilla Bunglows, New Alkapuri, Vadodara-391101
  //                   </Link>
  //                 </h4>
  //               </div>
  ...
  //                 </motion.div>
  //                 <h3 className="mb-0">
  //                   <Link to="mailto:arisehealthcaresolutions1@gmail.com" className="text-blue-900">
  ...
  //                     key={index}
  //                     href={item.link}
  //                     className="btn btn-lg-square btn-light rounded-circle mx-2 d-flex align-items-center justify-center mb-4"
