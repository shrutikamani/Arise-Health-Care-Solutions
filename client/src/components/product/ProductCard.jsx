...
//   return (
//     <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col max-w-sm mx-auto relative group">
...
//           src={imageUrl}
//           alt={product.title}
//           className="h-64 w-[25rem] object-cover cursor-pointer transform transition-transform duration-200 hover:scale-105"
//         />
...
//         {/* Title */}
//         <h3 className="text-lg font-semibold text-gray-800 capitalize truncate">{product.title}</h3>
...
//         {/* Description */}
//         {/* <p className="text-sm text-gray-600 mt-2 line-clamp-2">{truncate(product.description)}</p>
...
//           <p className="text-sm text-gray-600 mt-2 line-clamp-1">{truncate(featureText)}</p>
...
//         {/* Category (Optional, Hidden for Compact Design) */}
