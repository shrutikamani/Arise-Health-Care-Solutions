...
//     useEffect(() => {
//       const handleScroll = () => setSticky(window.scrollY > 35);
...
//           {/* Navbar Links */}
//           <div
//             className={`lg:flex lg:items-center absolute lg:static top-full left-0 w-full lg:w-auto bg-white lg:bg-transparent shadow-md lg:shadow-none p-4 lg:p-0 transition-all duration-300 ${navbarOpen ? "block" : "hidden"
//               }`}
//           >
...
//             {/* Orders Icon */}
//             <Link
//               to={`/orders/${effectiveUserId}`} // Use effectiveUserId instead of response
//               onClick={closeNavbar}
