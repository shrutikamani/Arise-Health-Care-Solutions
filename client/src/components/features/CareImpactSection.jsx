...
// {
//   return (
//     <section className=" text-center min-h-screen py-28 px-4 relative bg-[#CFDCE9]" >
//       {/* Background Illustration if needed */}
//       <div
//         className="absolute inset-0 opacity-11 bg-no-repeat bg-center bg-contain pointer-events-none"
//         style={{
          // backgroundImage: "url('https://www.agilitihealth.com/wp-content/uploads/2023/04/healthcare-system-diagram.png')",
//         }}
//       ></div>
//       <div className="max-w-4xl mx-auto relative z-10">
//         <h2 className="text-4xl md:text-4xl font-bold text-[#003963] mb-6 leading-snug">
//           How Will This Impact Care & Costs In My{" "}<br></br>
//           <span className="bg-blue-700 text-white px-2 rounded">Health System</span>
//         </h2>

//         <p className="text-gray-800 text-xl leading-relaxed mb-8">
//           <strong className="text-black text-2xl">Ready to talk with anArise HealthCare inventory management expert?</strong>{" "}
//           Every system faces unique challenges. The locations of your facilities,
//           the populations you serve, your mix of critical care and surgical offerings,
//           your workflows, and the composition of your clinical and operational teams all factor into
//           the design of the right equipment management solution.Arise HealthCare experts can draw on our experience
//           from more than 10,000+ healthcare facilities and health systems across the country to show you
...
//           <span className="absolute inset-0 rounded-full border-2 border-blue-700 animate-waves"></span>

//           {/* Actual button */}
//           <Link
//             to="/contactUs"
//             className="relative z-10 bg-white text-blue-800 font-semibold text-2xl px-10 py-4 border border-blue-800 rounded hover:bg-blue-800 hover:text-white transition"
//           >
//             Let's Talk
//           </Link>
//         </div>
